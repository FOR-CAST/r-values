...
## Assign colours to bins based on average raw r-values in each bin (using BC FIDS heuristic)
...
abr.lm.early <- lm(
  log10(r + 1) ~ beetle_yr + plot_lat_dd + plot_lon_dd +
